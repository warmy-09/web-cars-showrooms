...
const PriceList = () => {
  ...
  // --- DATA KENDARAAN DENGAN IMAGE YANG SUDAH DI-UPDATE ---
  const carsData = [
    // --- PASSENGER CARS ---
    {
      id: 1, 
      ...
      image: '/destinator_card.png', // UPDATED
    ...
    },
    {
      ...
      image: '/destinator_card.png', // UPDATED (Menggunakan base model yang sama)
    ...
    },
    {
      ...
      image: '/xpander_card.jpg', // UPDATED
      variants: [
    ...
    },
    {
      ...
      image: '/xpander_cross_card.png', // UPDATED
      variants: [
    ...
    // --- LIGHT COMMERCIAL VEHICLES ---
    {
      ...
      image: '/card.png', // Belum ada di list, pakai blank image
      variants: [
            ...
            <div key={car.id} className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden hover:shadow-md transition-shadow">
              <div className="p-6 md:p-8 flex flex-col md:flex-row items-center md:items-start gap-8 border-b border-gray-100 bg-white">
                <div className="w-full md:w-1/3 flex justify-center bg-gray-50 rounded-xl p-4">
                  {/* Gambar Kendaraan dengan Handle Error */}
                    <img 
                    src={car.image} 
                    alt={car.name} 
                    className="w-full h-auto object-contain max-h-48 drop-shadow-lg" 
                    onError={(e) => { 
                        // Menggunakan URL yang lebih cepat dan warna yang lebih soft (abu-abu terang)
                ...
                <div className="w-full md:w-2/3 flex flex-col justify-between h-full">
                  <div>
                    <div className="flex justify-between items-start mb-2">
                      ...
                      {/* Link text kanan atas (Opsional tapi bagus untuk Desktop) */}
                  ...
                  {/* Tambahan Tombol Lihat Detail di sebelah E-Brosur */}
