...
import { useNewsDetail } from '../hooks/useNewsData';
import { useResourcesCars } from '../hooks/useResourcesData';
...
const NewsDetail = () => {
  ...
  const { data: article, isLoading: isLoadingArticle } = useNewsDetail(slug);
  ...
  const relatedProducts = useMemo(() => {
    if (!article || !Array.isArray(cars) || cars.length === 0) return [];
  ...
  const isLoading = isLoadingArticle || isLoadingCars;
