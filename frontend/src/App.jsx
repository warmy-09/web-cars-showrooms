...
import ResourceCarDetail from './pages/ResourceCarDetail';
import ResourceArticleDetail from './pages/ResourceArticleDetail';
    ...
    <div className="min-h-screen flex flex-col bg-white font-sans text-gray-900 overflow-x-hidden">
      ...
      <main className={`flex-grow ${isHome ? 'pt-0' : 'pt-20'}`}>
        <Routes>
          ...
          <Route path="/resources/:slug" element={<ResourceCarDetail />} />
          <Route path="/resources/:slug/:articleSlug" element={<ResourceArticleDetail />} />
